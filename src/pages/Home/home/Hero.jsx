...
function Hero() {
  return (
    <div className="h-full bg-gradient-to-r from-[#030617] to-[#261215]  lg:grid lg:grid-cols-2  xl:px-24 lg:px-10 pb-10">
      <div className="text-center lg:text-start space-y-7 pt-10 lg:pt-20">
        <p className="text-[#e1781f] bg-[#352018] rounded-full w-32 p-2 mx-auto lg:mx-0">
          #Special Food
        </p>
        <h2 className="text-white mx-14 md:mx-10 lg:mx-0 font-bold text-3xl md:text-5xl lg:pr-20 ">

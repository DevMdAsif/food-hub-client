...
const Footer = () => {
  ...
  return (
    <footer className="h-full pt-14 pl-2  bg-[#020617]">
      <div className="md:grid pb-10 xl:px-20">
        <div className="mt-7 md:col-start-2 xl:col-start-1 ">
          ...
          <div className="text-[#94a3b8] text-sm mt-3 space-y-2">
        ...
        <div className="mt-7 md:col-start-4  lg:col-start-5 xl:col-start-4">
          ...
          <div className="text-[#94a3b8] mt-3 space-y-2">
        ...
        <div className="mt-4 md:mt-7 md:col-start-7 lg:col-start-7">
          <h2 className="text-2xl text-white">Specialties</h2>
          <div className="text-[#94a3b8] mt-3 space-y-2">
        ...
        <div className="space-y-3 md:mt-7 md:col-start-10 lg:col-start-9 xl:col-start-10">
          ...
          <div className="text-[#94a3b8] space-y-2 tracking-tight">
          ...
          <div className="inline-flex text-2xl text-[#94a3b8] space-x-3">
            <a href="#">
        ...
        <div className="inline-grid mt-4 md:mt-7 md:col-start-1  md:col-end-13 lg:col-start-11 md:ml-10 lg:ml-0 xl:col-start-12 ">
          <h2 className="text-2xl text-white">Join Our Newsletter</h2>
          ...
          <p className="text-[#94a3b8] mt-5 xl:pr-0 lg:w-[300px] xl:w-72">
      ...
      <span className="block md:text-lg text-base text-[#7889a0] text-center  py-5">
